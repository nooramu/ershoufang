<template>
	<div class="common-layout">
		<el-container>
      <!-- <div style='background:	#FAFAD2;display:flex;height:48px;justify-content: center;align-items: center;color:		#696969'>测试账号：123666 密码：w123666</div> -->
...
<script lang="ts" setup>
	...
	import {
		login, register,reset,returnMenuList
	} from '@/api/login'
