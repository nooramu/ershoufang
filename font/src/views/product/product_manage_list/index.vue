	...
	<div class="module-common-wrapped">
		<div class="module-common-content">
			<el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
				<el-tab-pane label="房屋列表" name="first">
                      ...
                      <Search />
							...
							<div class="module-common-table">
								<el-table :data="tableData" border style="width: 100%">
									...
									<el-table-column prop="product_name" label="房屋名称" width="160" />
									<el-table-column prop="product_category" label="户型" width="100" />
									<el-table-column prop="product_unit" label="单位" />
									<el-table-column prop="product_in_warehouse_number" label="房屋数量" width="100" />
									<el-table-column prop="product_single_price" label="月租" width="150" />
									<!-- <el-table-column prop="product_all_price" label="月租" width="100" /> -->
...
<script lang='ts' setup>
	...
	const productCurrentChange = async (value: number) => {
		...
		console.log(paginationData.productCurrentPage,"???")
